...
#    Updated: 2022/11/09 22:22:04 by bamsyah          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_calloc.c  ft_isdigit.c ft_memcmp.c  ft_strchr.c  ft_strlcpy.c ft_strrchr.c ft_toupper.c \
	...
	ft_atoi.c    ft_isalpha.c ft_itoa.c    ft_memmove.c ft_strjoin.c ft_strncmp.c ft_substr.c \
...
OBJ = ft_calloc.o  ft_isdigit.o ft_memcmp.o  ft_strchr.o  ft_strlcpy.o ft_strrchr.o ft_toupper.o \
	...
	ft_atoi.o    ft_isalpha.o ft_itoa.o    ft_memmove.o ft_strjoin.o ft_strncmp.o ft_substr.o \
